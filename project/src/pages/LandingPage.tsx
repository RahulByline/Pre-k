...
const LandingPage: React.FC = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-brand-background text-brand-text font-sans relative overflow-hidden p-4 sm:p-6 md:p-8">
      ...
      <div className="relative z-10">
        ...
        <main className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 pt-16 md:pt-24 lg:pt-32 mb-[4rem]">
          <motion.div 
           ...
           >
            <div className="flex justify-center lg:justify-start lg:pl-8">
              <img src="/KODEIT_Logo_2.png" alt="Kodeit Learnings Logo" className="h-[12rem] w-[18rem] mb-3 ml-[3rem]" />
            </div>
            
            <h1 className="text-5xl md:text-6xl font-extrabold uppercase leading-tight text-brand-text">
              Kodeit Learnings 
            </h1>
            <h2 className="text-lg font-semibold tracking-wider text-brand-text/80">
              WELCOME TO THE LEARNING CENTER
            </h2>
            <p className="max-w-md text-brand-text/70 mx-auto lg:mx-0">
            ...
            <div className="pt-4">
              <motion.button 
                ...
                className="bg-brand-accent text-white font-bold py-3 px-10 rounded-full shadow-lg hover:brightness-110 transition-all"
          ...
          >
            <img 
              ...
              className="w-full max-w-md md:max-w-xl lg:max-w-2xl h-auto object-cover"
            />
          </motion.div>
        </main>
      </div>
